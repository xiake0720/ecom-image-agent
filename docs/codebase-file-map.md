...
- `backend/db/models/task.py`：`tasks` / `task_assets` / `task_results` / `task_events` / `task_usage_records`
...
- `frontend/src/pages/LoginPage.tsx`：登录页壳层
- `frontend/src/pages/RegisterPage.tsx`：注册页壳层
- `frontend/src/pages/MainImagePage.tsx`：主图工作台
- `frontend/src/pages/DetailPageGeneratorPage.tsx`：详情图工作台
- `frontend/src/pages/TasksPage.tsx`：历史任务页
...
4. `docs/database-schema-v1.md`
5. `docs/api.md`
6. `docs/storage.md`
7. `docs/frontend-workbench.md`
