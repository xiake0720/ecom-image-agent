    ...
    def render_overlay(
        ...
        *,
        ...
        with Image.open(image_path).convert("RGBA") as base:
            ...
            font_source = title_source if title_source == subtitle_source else f"{title_source}|{subtitle_source}"
            return OverlayRenderReport(
                shot_id=shot_id,
                overlay_applied=True,
                font_source=font_source,
                fallback_used=title_fallback or subtitle_fallback,
                title_box=title_box,
